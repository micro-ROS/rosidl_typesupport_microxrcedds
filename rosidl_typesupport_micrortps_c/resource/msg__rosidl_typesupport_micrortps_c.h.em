...
header_guard_parts = [
    ...
    get_header_filename_from_msg_name(spec.base_type.type) + '__rosidl_typesupport_micrortps_c_h']
...
#include "@(spec.base_type.pkg_name)/msg/rosidl_typesupport_micrortps_c__visibility_control.h"
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_micrortps_c, @(spec.base_type.pkg_name), @(subfolder), @(spec.base_type.type))();
