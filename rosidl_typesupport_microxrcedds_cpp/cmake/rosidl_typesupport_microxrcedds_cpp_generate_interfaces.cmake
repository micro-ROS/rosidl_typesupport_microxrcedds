...
foreach(_idl_file ${rosidl_generate_interfaces_IDL_FILES})
  ...
  if(_extension STREQUAL ".msg")
    ...
    list(APPEND ${_var2} "${_output_path}/${_parent_folder}/${_header_name}__rosidl_typesupport_microxrcedds_cpp.hpp")
    list(APPEND ${_var2} "${_output_path}/${_parent_folder}/dds_microxrcedds/${_header_name}__type_support_cpp.cpp")
  elseif(_extension STREQUAL ".srv")
    list(APPEND _generated_srv_files "${_output_path}/srv/${_header_name}__rosidl_typesupport_microxrcedds_cpp.hpp")
    list(APPEND _generated_srv_files "${_output_path}/srv/dds_microxrcedds/${_header_name}__type_support_cpp.cpp")
  else()
