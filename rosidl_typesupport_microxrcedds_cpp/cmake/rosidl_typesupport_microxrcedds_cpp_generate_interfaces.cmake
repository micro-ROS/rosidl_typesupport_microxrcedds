...
foreach(_idl_file ${rosidl_generate_interfaces_IDL_FILES})
  ...
  list(APPEND _generated_files "${_output_path}/${_parent_folder}/${_header_name}__rosidl_typesupport_microxrcedds_cpp.hpp")
  list(APPEND _generated_files "${_output_path}/${_parent_folder}/dds_microxrcedds/${_header_name}__type_support_cpp.cpp")
endforeach()
